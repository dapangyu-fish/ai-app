...
install -m 644 "$ROOT_DIR/deploy/production/docker-compose.edge.yml" "$INSTALL_ROOT/deploy/production/docker-compose.edge.yml"
...
echo "compose: $INSTALL_ROOT/deploy/production/docker-compose.edge.yml"
