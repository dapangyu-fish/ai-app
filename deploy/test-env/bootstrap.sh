...
append_provider_env() {
  ...
  append_provider_line "${prefix}_AI_WORKER_MAX_CONCURRENCY" \
    "$(env_value "${prefix}_AI_WORKER_MAX_CONCURRENCY" "$AI_WORKER_PROVIDER_DEFAULT_MAX_CONCURRENCY")"
  append_provider_line "${prefix}_AI_WORKER_QUEUE_MAX" \
    "$(env_value "${prefix}_AI_WORKER_QUEUE_MAX" "$AI_WORKER_PROVIDER_DEFAULT_QUEUE_MAX")"
}
...
AI_WORKER_MAX_CONCURRENCY="${AI_WORKER_MAX_CONCURRENCY:-3}"
AI_WORKER_QUEUE_MAX="${AI_WORKER_QUEUE_MAX:-50}"
AI_WORKER_PROVIDER_DEFAULT_MAX_CONCURRENCY="${AI_WORKER_PROVIDER_DEFAULT_MAX_CONCURRENCY:-$AI_WORKER_MAX_CONCURRENCY}"
AI_WORKER_PROVIDER_DEFAULT_QUEUE_MAX="${AI_WORKER_PROVIDER_DEFAULT_QUEUE_MAX:-$AI_WORKER_QUEUE_MAX}"
...
export AI_WORKER_MAX_CONCURRENCY AI_WORKER_QUEUE_MAX AI_WORKER_PROVIDER_DEFAULT_MAX_CONCURRENCY AI_WORKER_PROVIDER_DEFAULT_QUEUE_MAX
