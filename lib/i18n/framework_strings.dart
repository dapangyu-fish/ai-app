...
const _Strings _zhCN = _Strings(
  ...
  onboardingStep1Body: '长按 1.5 秒进入 AI 对话——跟它说"做一个 todo list"就能生成完整 APP，还能反复改。可拖动到屏幕任意位置；双击回到上次对话。',
...
const _Strings _enUS = _Strings(
  ...
  onboardingStep1Body: 'Long-press for 1.5s to open AI chat—say "make me a todo list" and get a working app you can keep iterating on. Drag anywhere to move; double-tap to resume the last conversation.',
