...
> **AI को बताएँ → फुल-स्टैक ऐप (UI + बैकएंड + डेटाबेस) → तुरंत उपयोगकर्ता के फ़ोन पर चलता हुआ। कोई बिल्ड चरण नहीं, कोई ऐप-स्टोर समीक्षा नहीं।**
>
> एक Flutter रनटाइम जो JSON-DSL की व्याख्या करके मूल UI + बिज़नेस लॉजिक में बदलता है। उपयोगकर्ता AI को बताते हैं कि उन्हें क्या चाहिए; AI JSON फ्रंट-एंड **और, जब ऐप को इसकी ज़रूरत हो, अपने अलग-थलग Postgres डेटाबेस के साथ एक असली Python/Flask बैकएंड** उत्सर्जित करता है — फिर इसे एक पूर्व-संकलित क्षमता सेट के भीतर तुरंत रेंडर और चलाता है। अन्य AI ऐप बिल्डर आपको फ्रंट-एंड कोड देते हैं जिसे आपको स्वयं जोड़ना और तैनात करना पड़ता है; MyApp पूरा स्टैक भेजता है, जो पहले से ही चल रहा होता है।
...
1. **एक Flutter सर्वर-संचालित UI इंजन** (`lib/`) — किसी भी JSON-DSL कॉन्फ़िग को रनटाइम पर एक असली क्रॉस-प्लेटफ़ॉर्म ऐप में रेंडर करता है
...
3. **एक पैकेज इकोसिस्टम** (`templates/`) — उदाहरण JSON-APP (IM, गेम, उपयोगकर्ता प्रोफ़ाइल, कैलकुलेटर…) जिन्हें आप रनटाइम के ऊपर इंस्टॉल कर सकते हैं

नाम **MyApp** जानबूझकर रखा गया है: प्रत्येक उपयोगकर्ता साझा रनटाइम के ऊपर "मेरा ऐप" बना, इंस्टॉल और संचालित कर सकता है।

प्रमुख उपयोग का मामला: **एक उपयोगकर्ता ऐप खोलता है → AI से चैट करता है (जनरेशन में आमतौर पर 10-20 मिनट लगते हैं) → AI एक JSON-DSL लौटाता है → ऐप इसे क्लाइंट में पहले से संकलित क्षमताओं के भीतर तुरंत लोड और चलाता है।**
...
- **क्रॉस-प्लेटफ़ॉर्म** — वही JSON-DSL iOS, Android, Web (उत्पादन-परीक्षित), macOS (प्रायोगिक रूप से परीक्षित), Linux, Windows पर रेंडर होता है। मुख्य फीचर सभी प्लेटफ़ॉर्म पर काम करते हैं; प्लेटफ़ॉर्म-विशिष्ट फीचर (IM, पुश) असमर्थित प्लेटफ़ॉर्म पर सुचारू रूप से घटित होते हैं।
...
### इंजन
- 30+ विजेट (text / button / input / list / image / video / chart / map / webview / camera / qr / चैट बबल / …)
- 15 कस्टम ऑपरेटरों के साथ JsonLogic एक्सप्रेशन इंजन
- 30+ अंतर्निहित फ़ंक्शन (HTTP, JSON, स्ट्रिंग, ऐरे, कंट्रोल फ़्लो, UI फीडबैक)
...
- Flame 2D गेम इंजन (स्प्राइट, फ़िज़िक्स, Tiled मैप)
...
- **ज़ीरो-लॉगिन डेमो मोड** — अप्रमाणित उपयोगकर्ता फ्लोटिंग बॉल पर टैप करते हैं → Demo, एक असली-दिखने वाली AI जनरेशन शुरू करते हैं जो एक रिकॉर्ड किए गए सेशन को SSE-रीप्ले करती है, और एक वास्तव में चलने योग्य ऐप पाते हैं (कोई agent-node नहीं, कोई FaaS निर्माण नहीं) — पूरे फ़्लो का तत्काल स्वाद
...
| क्षेत्र | अवस्था |
|---|---|
| इंजन (Dart) | उत्पादन। 65k LOC। एक असली ऐप को संचालित करता है। क्लाइंट UI 11 भाषाओं में स्थानीयकृत। |
...
| API स्थिरता | DSL v3.3 — v4 तक छोटे ब्रेकिंग बदलाव संभव हैं। बैकएंड HTTP API स्थिर। |
...
- [ ] एक 60-सेकंड वायरल डेमो वीडियो जारी करें (AI → ~10-20 मिनट में JSON कॉन्फ़िग → ऐप तुरंत चलता है)
