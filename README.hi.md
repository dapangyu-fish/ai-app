...
2. **एक फुल-स्टैक AI जनरेटर** (`backend/`, `config_center/`) — AI JSON फ्रंट-एंड **और एक मेल खाता FaaS बैकएंड + अलग-थलग Postgres डेटाबेस** उत्पन्न करता है जब ऐप को इसकी ज़रूरत हो, ऑथ (Supabase), IM (OpenIM), पुश (APNs + FCM), AI चैट प्रॉक्सी, पैकेज रजिस्ट्री, और उपयोगकर्ता एडमिन के ऊपर।
...
- **सर्वर-संचालित** — UI और व्यवहार डेटा को एक निश्चित, पूर्व-संकलित रनटाइम सीमा के माध्यम से भेजें। [ऐप स्टोर अनुपालन नोट्स](docs/APP_STORE_COMPLIANCE.md) देखें। <sub>(ये नोट काफ़ी पहले लिखे गए थे और शायद अब 100% अद्यतित न हों; मैं इसे ऐप स्टोर पर लाने की पूरी कोशिश करूँगा)</sub>
...
- **बैटरीज़ शामिल** — पुश के साथ IM, AI प्रॉक्सी, पैकेज रजिस्ट्री, नेमस्पेस, मिररिंग, एनवायरनमेंट स्विचिंग — सब एक साथ जुड़े हुए। "एक और लो-कोड फ्रेमवर्क जो ऑथ को टाल देता है" नहीं।
...
## यह प्रोजेक्ट क्यों मौजूद है — लेखक की ओर से एक नोट
...
- App बैकएंड + AI वर्कर + Registry + Config center
