...
try:
    DEFAULT_NODE_CAPACITY = max(1, int(os.environ.get("AGENT_NODE_CAPACITY", "10")))
except ValueError:
    DEFAULT_NODE_CAPACITY = 10
try:
    DEFAULT_NODE_QUEUE_MAX = max(0, int(os.environ.get("AGENT_NODE_QUEUE_MAX", "100")))
except ValueError:
    DEFAULT_NODE_QUEUE_MAX = 100
