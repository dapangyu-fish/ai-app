...
faas_store.add_maintainer = lambda *a, **k: None
faas_store.delete_application = lambda *a, **k: None
faas_store.grant_consumer = lambda *a, **k: None
faas_store.list_audit_log = lambda *a, **k: None
faas_store.list_consumers = lambda *a, **k: None
faas_store.list_maintainers = lambda *a, **k: None
faas_store.list_user_applications = lambda *a, **k: None
faas_store.remove_maintainer = lambda *a, **k: None
faas_store.revoke_consumer = lambda *a, **k: None
faas_store.set_application_policy = lambda *a, **k: None
